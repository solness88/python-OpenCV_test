...
video = cv2.VideoCapture('/Users/hirokoba/workspace/Tracking/videos/walking.avi')
...
while True:
    ...
    if ok:
        ...
        cv2.rectangle(frame, (x, y), (x + y, y + h), colors)
    else:
        print('Tracking failure! We will execute the haarcascade detection.')
        bbox = detect()
