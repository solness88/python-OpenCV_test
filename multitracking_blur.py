...
#Choose alghorithms for movie-tracking
...
video = cv2.VideoCapture('/Users/hirokoba/workspace/Tracking/videos/race.mp4')
...
while video.isOpened():
    ...
    for i, new_box in enumerate(boxes):
        ...
        frame[y : y+h, x : x+w] = mosaic(frame[y : y + h, x : x + w], 0.2)
